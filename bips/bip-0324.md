...
##### Keys and session ID derivation {#keys_and_session_id_derivation}
...
##### Overall handshake pseudocode {#overall_handshake_pseudocode}
...
### Transport layer specification {#transport_layer_specification}
