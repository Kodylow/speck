...
### Descriptor Template {#descriptor_template}
...
### Mode: `NO_ENCRYPTION` with Public Keys {#mode_no_encryption_with_public_keys}
...
### Mode: `NO_ENCRYPTION` {#mode_no_encryption}
...
### Mode: `STANDARD` Encryption {#mode_standard_encryption}
...
### Mode: `EXTENDED` Encryption {#mode_extended_encryption}
